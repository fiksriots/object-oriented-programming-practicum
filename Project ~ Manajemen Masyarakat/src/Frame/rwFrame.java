...
public class rwFrame extends JFrame{
    int angka = 1;
     ...
     public rwFrame(){
    JFrame GUIrw = new JFrame();
    GUIrw.setSize(800, 900);
    GUIrw.setVisible(true);
    GUIrw.setLocationRelativeTo(null);
    GUIrw.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    GUIrw.setTitle("RW");
    GUIrw.setLayout(null);
    
        JLabel label = new JLabel("RW");
        label.setBounds(350, 10, 300, 100);
        label.setFont(new Font("Times new roman",Font.BOLD,50));
        GUIrw.add(label);
        JLabel nama = new JLabel("nama ketua rw");
        ...
        GUIrw.add(rt);*/
        Object[] coloumnName = {
        "RW","Ketua RW","No Hp","alamat"
         };
        Object[][] data;
        DefaultTableModel model = new DefaultTableModel(coloumnName,0);
        JTable tableRW = new JTable(model);
        JScrollPane scroll = new JScrollPane(tableRW);
        scroll.setBounds(350, 100, 400, 500);
        GUIrw.add(scroll);
        tableRW.setModel(allObject.dataRw.viewTabel());
    
    JButton insert = new JButton("Tambah RW");
    ...
    insert.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            allObject.dataRw.insertRW(nm.getText(), np.getText(), almt.getText());
            tableRW.setModel(allObject.dataRw.viewTabel());
            angka++;
        }}
    });
    ...
    GUIrw.add(insert);
    JButton update = new JButton("Update RW ");
    ...
    update.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            try{
            allObject.dataRw.update(Integer.parseInt(rw.getText()), nm.getText(), almt.getText(), np.getText());
            tableRW.setModel(allObject.dataRw.viewTabel());
        }catch(Exception a){
    ...
    view.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            /*  scroll.setModel(allObject.datamatkul.viewTabel());
            kosong();*/
